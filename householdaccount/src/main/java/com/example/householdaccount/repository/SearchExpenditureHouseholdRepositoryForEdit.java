...
public interface SearchExpenditureHouseholdRepositoryForEdit extends JpaRepository<SearchResultExpenditureForEditAndDelete, ExpenditureNoVO> {
	//試作
		...
		public SearchResultExpenditureForEditAndDelete findExpenditureByBalanceCode(String balanceCode);
}
